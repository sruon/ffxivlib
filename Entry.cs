    ...
    public partial class Chatlog
    {
        public class Entry
        {
                ...
                private void processEntry(byte[] raw)
                {
                    ...
                    try
                    {
                        this.timestamp = getTimeStamp((double)
                            int.Parse(
                    ...
                    this.code = Encoding.UTF8.GetString(working_copy.ToArray(), 0, Constants.CHATCODE_SIZE);
                    ...
                    this.text = cleanString(Encoding.UTF8.GetString(working_copy.ToArray()));
                }
                /// <summary>
                    ...
                    List<byte> pattern = new List<byte>
                {
                    ...
                    List<byte> hq_rep = new List<byte>
                {
                    0x48,
                    0x51
                };
